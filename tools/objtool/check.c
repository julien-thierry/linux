...
{
	if (state->cfa.base == CFI_BP && state->cfa.offset == CFA_SIZE &&
	    state->regs[CFI_BP].base == CFI_CFA &&
	    state->regs[CFI_BP].offset == CFA_BP_OFFSET &&
	    state->regs[CFI_RA].base == CFI_CFA &&
	    state->regs[CFI_RA].offset == CFA_RA_OFFSET)
		return true;
